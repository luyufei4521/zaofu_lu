...
def channel_event_schema_rules() -> dict[str, dict[str, Any]]:
    ...
    return {
        ...
        "channel.message.pinned": {
            "required": [*base, "message_id", "pinned", "member_id"],
        ...
        "channel.context_pack.built": {
            ...
            "optional": [
                ...
                "message_ref_count",
                "question_ref_count",
                "question_frontier_count",
                "owner_question_count",
                "cross_review_count",
                "contribution_ref_count",
                "artifact_ref_count",
                "report_ref_count",
                "question_frontier_digest",
                "owner_questionnaire_digest",
                "cross_review_index_digest",
                "contribution_index_digest",
                "refs",
            ],
        },
        ...
        "channel.cross_review.rejected": {
            "required": [*base, "request_id", "target_member_id", "reason"],
            "optional": ["schema_version", "question_id"],
        },
        "channel.consensus.review.rejected": {
            "required": [*base, "review_id", "member_id", "reason"],
            "optional": [
                "artifact_ref",
                "artifact_digest",
                "expected_artifact_digest",
                "supplied_artifact_digest",
                "summary",
                "evidence_refs",
            ],
        },
