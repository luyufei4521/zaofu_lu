...
KNOWN_EVENT_TYPES: frozenset[str] = frozenset({
    ...
    # Evidence-bound harness self-evolution (design 176)
    "evolution.attempt.proposed", "evolution.attempt.materialized",
    "evolution.evaluator.registered",
    "evolution.trial.started", "evolution.trial.completed",
    "evolution.trial.retry.requested",
    "evolution.comparison.completed",
    "evolution.adoption.proposed", "evolution.adoption.approved",
    "evolution.adoption.rejected",
    "evolution.asset.validated", "evolution.asset.applied",
    "evolution.asset.retained", "evolution.asset.revoked",
    "evolution.asset.superseded", "evolution.asset.expired",
    "evolution.asset.transitioned", "evolution.canary.completed",
    "evolution.asset.outcome.recorded", "evolution.asset.exported",
    "evolution.asset.imported", "evolution.asset.target_validated",
    "evolution.workflow.proposal.compiled",
    "evolution.variant.comparison.completed",
    "evolution.opportunity.proposed",
    "evolution.campaign.requested", "evolution.campaign.materialized",
    "evolution.campaign.declined", "evolution.campaign.completed",
    ...
    "evolution.skill_optimizer.step.prepared",
    "evolution.skill_optimizer.step.completed",
    "evolution.skill_optimizer.completed",
    "evolution.skill_optimizer.candidate.exported",
    "evolution.skill_optimizer.proposal.requested",
    "evolution.skill_optimizer.selection.requested",
    "evolution.skill_optimizer.selection.completed",
    "evolution.skill_optimizer.selection.rejected",
    "evolution.skill_optimizer.selection.superseded",
    ...
    "task.contract.update", "task.contract.change.requested",
    "task.contract.mutation.prepared", "task.contract.revision.applied",
    "task.contract.change.rejected", "task.evidence_linked",
    ...
    "task.attempt.delivery_claimed", "task.attempt.sent",
    "task.attempt.superseded", "task.attempt.result_rejected",
    "task.attempt.shadow_mismatch", "task.attempt.shadow.compared",
    ...
    "task.pipeline.stage.dispatch_deferred",
    "task.pipeline.stage.waiting",
    "task.pipeline.external_gate.satisfied",
    ...
    "task.pipeline.acceptance.revision_requested",
    "task.pipeline.acceptance.replan_requested",
    "task.pipeline.acceptance.blocked",
    "task.pipeline.stage.session.archived",
    "task.pipeline.sessions.archived",
    ...
    "plan.synth.owner_decision.requested",
    "plan.synth.owner_decision.resolved",
    ...
    "kanban.agent.plan.requested", "kanban.agent.plan.answered",
    "kanban.agent.plan.repair.requested", "kanban.agent.plan.repair.completed",
    "kanban.agent.plan.repair.exhausted",
    ...
    "run.paused", "run.resumed", "run.dispatch.blocked",
    "run.result.rejected", "run.result.duplicate_suppressed",
    "run.admission.requested", "run.admission.admitted",
    "run.admission.queued", "run.admission.released",
    ...
    "provider.session.config.resolved", "provider.session.config.recycled",
    ...
    "feishu.inbound_bridge.started", "feishu.inbound_bridge.shared",
    "feishu.inbound_bridge.skipped", "feishu.inbound_bridge.failed",
    "feishu.inbound_bridge.detached", "feishu.inbound_bridge.stopped",
    ...
    "channel.question.opened", "channel.question.updated",
    ...
    "channel.result.receipt.recorded", "channel.result.receipt.failed",
    ...
    "workflow.synthesis.queued", "workflow.synthesis.operation.bound",
    "workflow.synthesis.requested", "workflow.synthesis.retried",
    "workflow.synthesis.result.prepared", "workflow.synthesis.admitted",
    "workflow.synthesis.clarification.required", "workflow.synthesis.failed",
    "workflow.synthesis.proposal.failed", "workflow.synthesis.cancelled",
    ...
    "research.child.completed", "research.child.failed",
    "research.fanout.completed", "research.fanout.failed",
    "research.adaptive.completed", "research.adaptive.failed",
    ...
    "fanout.aggregate.completed", "fanout.aggregate.rebuild.requested",
    ...
    "orchestrator.semantic.checkpoint.rejected",
    ...
    "orchestrator.semantic.decision.admitted",
    ...
    "owner.delivery.narrative.admitted",
    ...
    # Durable provider-process lifecycle for a dispatched repair attempt.
    "autoresearch.repair.spawned",
    "autoresearch.repair.terminated",
    ...
    "provider.operation.summary.recorded",
